...
class ExampleLayer : public Mochii::Layer {
 public:
  ExampleLayer() : Layer("Example"), _CameraController(1280.0f / 720.0f) {
    ...
    vertexBuffer.reset(
        Mochii::VertexBuffer::Create(vertices, sizeof(vertices)));
    ...
    indexBuffer.reset(Mochii::IndexBuffer::Create(
    ...
    squareVB.reset(
        Mochii::VertexBuffer::Create(squareVertices, sizeof(squareVertices)));
    squareVB->SetLayout({{Mochii::ShaderDataType::Float3, "a_Position"},
                         {Mochii::ShaderDataType::Float2, "a_TexCoord"}});
    _SquareVA->AddVertexBuffer(squareVB);

    uint32_t squareIndices[6] = {0, 1, 2, 2, 3, 0};
    Mochii::Ref<Mochii::IndexBuffer> squareIB;
    squareIB.reset(Mochii::IndexBuffer::Create(
    ...
    _FlatColorShader = Mochii::Shader::Create(
    ...
    std::dynamic_pointer_cast<Mochii::OpenGLShader>(textureShader)
  ...
  void OnUpdate(Mochii::Timestep ts) override {
    ...
    std::dynamic_pointer_cast<Mochii::OpenGLShader>(_FlatColorShader)
    ...
    _Texture->Bind();
    Mochii::Renderer::Submit(textureShader, _SquareVA,
  ...
  void OnEvent(Mochii::Event& e) override { _CameraController.OnEvent(e); }
