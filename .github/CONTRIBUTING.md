...
Thanks for your interest in contributing to Mochii! :tada: We love getting [pull requests](https://www.quora.com/GitHub-What-is-a-pull-request) for bugfixes and contributions of our community to keep Mochii growing.
...
Please keep the code base, issues and pull requests in English only.
...
You've created a new fix or feature for Mochii. Awesome!

1. If you haven't already, create a fork of the Mochii repository.
...
- Naming convention:
  ...
  - For macros we use snake case: **`MACRO_NAME`**.
    - If it is specifically related to Mochii, we add the 'MI_' prefix: **`MI_MACRO_NAME`**.
    - If there is a macro for the application and for the engine, we add an additional 'CORE_' prefix to the engine macro:  **`MI_CORE_MACRO_NAME`**.
...
[issue-tracker]: https://github.com/oxodx/mochii/issues
[submit-pr]: https://github.com/oxodx/mochii/pulls
